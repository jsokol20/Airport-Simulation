...
public:
	...
	void show_stats()
	{
		...
		double averageLandingTime;
		averageLandingTime = landing_queue->get_total_wait() / landing_queue->get_num_served();
		std::cout << "Average Landing Time for the landing queue: " << averageLandingTime;
		...
		double averageDepartureTime;
		averageDepartureTime = departure_queue->get_total_wait() / departure_queue->get_num_served();
		std:: cout << "Average waiting time for all palnes in departure queue: " << averageDepartureTime;
		std::cout << std::endl;
